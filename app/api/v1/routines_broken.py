...
async def seed_templates(
    ...
    try:
            ...
            },
            {
                ...
                "steps": [
                    ...
                    },
                    {
                        "order": 2,
                        "category": "toner",
                        "product_name": "Peptide Toner",
                        "duration_seconds": 30,
                        "instructions": "Layer 2-3 times"
                    },
                    {
                        "order": 3,
                        "category": "serum",
                    ...
                    },
                    {
                        "order": 5,
                        "category": "eye_cream",
                        "product_name": "Firming Eye Complex",
                        "duration_seconds": 20,
                        "instructions": "Pat around eyes"
                    },
                    {
                        "order": 6,
                        "category": "moisturizer",
        ...
        return {
            "message": f"Successfully created {len(result.inserted_ids)} routine templates!",
            "template_count": len(result.inserted_ids)
        }
